...
export default class Calendar extends PureComponent {
  ...
  getVisibleDates() {
    ...
    // Iterate through `dayWidths`
    some(Object.values(dayWidths), (width, index) => {
  ...
  scrollToCurrentDay() {
    ...
    this.scrollViewRef.scrollTo({ x: scrollToX });
  };
  ...
  onRenderDay = (index, width) => {
    ...
    const allDatesHaveRendered = dayWidths && Object.keys(dayWidths).length >= showDaysBeforeCurrent + showDaysAfterCurrent;
